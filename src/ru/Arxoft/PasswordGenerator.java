...
public class PasswordGenerator {
    ...
    public static void main(String[] args) {
        ...
        int len = 10;
        System.out.println("Alpha password, length " + len + " chars: ");
        String password = generatePassword(len, ALPHA_CAPS + ALPHA);
        System.out.println(password);
        System.out.println();

        len = 20;
        System.out.println("Alpha + special password, length " + len + " chars: ");
        password = generatePassword(len, ALPHA_CAPS + ALPHA + SPECIAL_CHARS);
        System.out.println(password);
        System.out.println();

        len = 15;
        System.out.println("Alpha + numeric + special password, length " + len + " chars: ");
